...
namespace SwebSECUI.Layout
{
    ...
    {
        public ConOutChooseLayout() : base()
        {
            //This call is required by theSwebUserControl.
            InitializeComponent();
        }
        private DataTable SelectSource;
        public ConOutChooseLayout(DataTable dt) : base()
        {
            //This call is required by theSwebUserControl.
            InitializeComponent();
            SelectSource = dt;
        ...
        private void treeSelect1_Press(object sender, TreeSelectPressEventArgs args)
        {
            ...
            foreach (DataRow row in SelectSource.Rows)
            {
                if (row["CID"].ToString() == args.TreeID)
                {
                    ...
                    lblINStore.Text= row["QUANT"].ToString();
                    break;
                }
            }
        }
        ...
        public string QUANT
        {
            set { lblINStore.Text = value; }
            get { return lblINStore.Text; }
        }
